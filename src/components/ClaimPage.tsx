...
const ClaimPage = () => {
    ...
    const [formData, setFormData] = useState({address: "", secretKey: ""})
    ...
    const claimWill = (e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault();
    ...
    return (
        ...
        <section className="vh-lg-100 mt-5 mt-lg-0 bg-soft d-flex align-items-center">
            <div className="container">
                ...
                <div className="row justify-content-center form-bg-image" data-background-lg={ signin }>
                    <div className="col-12 d-flex align-items-center justify-content-center">
                        <div className="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                            <div className="text-center text-md-center mb-4 mt-md-0">
                                <h1 className="mb-0 h3">Claim your will</h1>
                            </div>
                            <form onSubmit={claimWill} action="#" className="mt-4">
                                <div className="form-group mb-4">
                                    <label htmlFor="email">Owner's account address</label>
                                    <div className="input-group">
                                        ...
                                        <input name="address" className="form-control" placeholder="Address" id="email" autoFocus required onChange={handleFormChange} />
                                    </div>  
                                </div>
                                <div className="form-group">
                                    <div className="form-group mb-4">
                                        ...
                                        <div className="input-group">
                                            ...
                                            <input name="secretKey"  type="password" placeholder="Secret Key" className="form-control" id="password" required onChange={handleFormChange} />
                                        </div>  
                                    </div>
                                ...
                                <div className="d-grid">
                                    <button type="submit" className="btn btn-gray-800">Claim Will</button>
                                </div>
                            </form>
