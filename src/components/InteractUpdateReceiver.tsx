...
const InteractUpdateReceiver = () => {
  ...
  const updateAddress = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    Tezos.wallet
      ...
      .then((contract) => {
        return contract.methods.updateReciever(address).send()
      }).then((contract) => {
...
<div className="row">
    <div className="col-12 col-xl-8"> 
        <div className="card card-body border-0 shadow mb-4">
            <h2 className="h5 mb-4">Update Receiver's Address</h2>
            <form onSubmit={updateAddress}>
                <div className="row">
                    <div className="col-md-6 mb-3">
                        <div>
                            <label htmlFor="first_name">Address (36 characters minimum)</label>
                            <input name="address" className="form-control" id="first_name" type="text" placeholder="address" required onChange={handleFormChange} />
                        </div>
                    </div>
...
export default InteractUpdateReceiver;
